...
# FRANCAIS :
#
# Conteneur de mot de passe a peu pres sécurisé, fait par AinTea#0519, si vous me creditez pas ou que vous partagez ce
# code sans me crediter bah vous serez mechant et c'est pas gentil d'etre mechant (JEEJ pour les connaisseurs)
#
# En gros ce code va creer un fichier mot de passe hashé pour verifier si vous avez entré le bon mot de passe
# et ca créé un fichier conteneur qui va stocker vos mots de passe sous format JSON mais crypté par un chiffrage XOR
#
# C'est clairement pas sécurisé a 100% hein j'suis un débutant la dedans donc je prefere prevenir
# Si vous voulez plus le sécuriser vous pouvez deja renforcer la methode de hashage en rajoutant des parties de hash par
# ci par la ou/et avoir un mot de passe plus fort parce que pour le cracker il "suffit" d'utiliser une methode de force brute
# vous pouvez essayer SUR LE VOTRE evidemment sinon c'est juste illegal
#
